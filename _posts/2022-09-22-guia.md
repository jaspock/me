...
En la sección de [PyTorch](#pytorch) puedes encontrar un programa muy corto que entrena y usa un modelo de lengua con redes *feedforward* como el estudiado en este bloque. No es necesario que entiendas este código antes de pasar al siguiente capítulo del libro, pero recuerda volver a él más adelante.
...
En la sección de [PyTorch](#pytorch) puedes encontrar una implementación de la arquitectura del transformer que hemos estudiado en este bloque. A estas alturas es aconsejable que vayas dedicando tiempo a estudiar la implementación, pero recuerda empezar por las implementaciones más sencillas de modelos de bloques anteriores.
...
- beam search [10.5]
- tokenización [2.4.3] y subword tokenization (BPE, sentencepiece)
...
- Un [regresor softmax para clasificar imágenes de dígitos](../../../assets/code/guia-transformers/softmax-regressor.py) <i class="fas fa-file"></i>. Las imágenes y etiquetas de los dígitos se toman de un conjunto de datos muy conocido llamado MNIST. Como ejercicio, puedes simplificar este código para que realice una tarea de clasificación de sentimiento sobre un conjunto de datos sintéticos muy pequeño que se defina explícitamente en el propio programa; puedes inspirarte en el código de los siguientes ejemplos para ello.
- Una implementación del algoritmo [skip-gram](https://github.com/jaspock/nlp-tutorial-graykode/blob/master/1-2.Word2Vec/Word2Vec-Skipgram(Softmax).py) <i class="fas fa-file"></i> para la obtención de embeddings incontextuales. El enfoque aquí seguido es el del trabajo "[Distributed Representations of Words and Phrases and their Compositionality](https://arxiv.org/abs/1310.4546)" de 2013 y no se ajusta totalmente al que hemos estudiado nosotros. Encuentra las diferencias e implementa como ejercicio la versión del libro de Jurafsky y Martin.
