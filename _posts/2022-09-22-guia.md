...
- Un [regresor softmax para clasificar imágenes de dígitos](../../assets/code/guia-transformers/softmax-regressor.py). Como ejercicio, puedes simplificar este código para que realice una tarea de clasificación de sentimiento sobre unos datos muy pequeños que se definan explícitamente en el propio programa; puedes inspirarte en el código de los siguientes ejemplos para ello.
- Una implementación del algoritmo [skip-gram](https://github.com/jaspock/nlp-tutorial-graykode/blob/master/1-2.Word2Vec/Word2Vec-Skipgram(Softmax).py) para la obtención de embeddings incontextuales realizada por [graykode](https://github.com/graykode/nlp-tutorial). La implementación es la del trabajo "[Distributed Representations of Words and Phrases and their Compositionality](https://arxiv.org/abs/1310.4546)" de 2013 y no se ajusta totalmente a la que hemos estudiado nosotros. Encuentra las diferencias e implementa como ejercicio la versión del libro de Jurafsky y Martin.
- Una implementación de un [modelo de lengua](https://github.com/jaspock/nlp-tutorial-graykode/blob/master/1-1.NNLM/NNLM.py) con redes *feedforward* como el que hemos visto en el capítulo de redes *feedforward* realizada por [graykode](https://github.com/graykode/nlp-tutorial). La implementación coincide con la del artículo "[A neural probabilistic language model](https://dl.acm.org/doi/10.5555/944919.944966)" de 2003, que puedes consultar si necesitas más información.
- Una implementación del [transformer](https://github.com/jaspock/nlp-tutorial-graykode/tree/master/5-1.Transformer) más compacta que la vamos a estudiar aquí realizada por [graykode](https://github.com/graykode/nlp-tutorial). La implementación sigue la del artículo "[Attention is all you need](https://arxiv.org/abs/1706.03762)" de 2017, que puedes consultar si necesitas más información.
- Una implementación del [modelo BERT](https://github.com/jaspock/nlp-tutorial-graykode/tree/master/5-2.BERT) realizada por [graykode](https://github.com/graykode/nlp-tutorial).
