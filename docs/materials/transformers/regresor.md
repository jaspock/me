...
Estudia este tema con el capítulo [:octicons-book-24:][logistic] "[Logistic Regression][logistic]" del libro de Jurafsky y Martin, complementándolo con lo que se discute más abajo.
