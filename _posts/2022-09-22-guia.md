...
En el bloque anterior, hemos estudiado todos los elementos del transformer, pero en aplicaciones en las que una secuencia de tokens se transforma en otra secuencia de tokens, las capas del transformen se asocian a dos submodelos bien diferenciados y conectados entre ellos mediante mecanismos de atención: el codificador y el descodificador. El capítulo "[Machine translation][mt]" <i class="fas fa-file"></i> se centra en la arquitectura completa. Salta la introducción y ve directo a la sección 10.1; después, sigue con las secciones 10.1 y 10.3; aborda a continuación el estudio de la sección 10.6 y acaba con la 10.5.
